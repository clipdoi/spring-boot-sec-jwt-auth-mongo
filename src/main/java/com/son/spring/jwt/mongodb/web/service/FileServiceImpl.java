...
import com.son.spring.jwt.mongodb.exception.ApiException;
...
public class FileServiceImpl implements FileService {
	...
	private void processLog(List<CsvData> oldData, List<CsvData> newData, User userEntity, String fileId) {
	...
	public GetActivityFile.Response getActivityFile(String userName) {
		User userEntity = userRepository.findByUsername(userName).orElseThrow(() -> new ApiException("User not found", "", ""));
		List<ActivityLog> activityLogs = userEntity.getActivityLogs();
